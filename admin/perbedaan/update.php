...
if ($gambar != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        $query  = mysqli_query($connection, "UPDATE perbedaan SET name = '$name', deskripsi = '$deskripsi', gambar = '$logo_baru' WHERE id = '$id'");
    ...
    // jalankan query UPDATE berdasarkan ID yang produknya kita edit
    $query  = mysqli_query($connection, "UPDATE perbedaan SET name = '$name', deskripsi = '$deskripsi' WHERE id = '$id'");
    // periska query apakah ada error
    if ($query) {
        $_SESSION['info'] = [
            'status' => 'success',
